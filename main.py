...
querystring = '(AF-ID (121522042) OR AF-ID(60032844))  AND  PUBYEAR  AFT 2009 AND PUBYEAR BEF 2021'

# задаем список идентификаторов, по которым проводится подсчет. их можно брать из RIRO, см https://openriro.github.io/ (таблица 6)

target_id = ['121522042','60032844']  #для примера используем два айди Russian State Hydrometeorological University
...
print('exported to c:\Ivan\scopuspubs.csv, tab-separated')
df.to_excel(r'c:\Ivan\scopuspubs.xlsx')
print('exported to c:\Ivan\scopuspubs.xlsx')